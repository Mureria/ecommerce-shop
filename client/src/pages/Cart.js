        ...
        <div className='max-w-[1200px] mx-auto my-4 mb-10 px-4'>
          ...
          <div className='flex flex-col md:flex-row items-start md:items-center justify-center bg-slate-100 gap-3 px-4 py-4 rounded-sm mt-4'>
            ...
            <div className='flex basis-[20%] text-center justify-center'>
              ...
              <div className=' border-slate-300 border-y py-0 px-7 text-[#333333]'>1</div>
          ...
          <div className='flex flex-col md:flex-row items-start md:items-center justify-center bg-slate-100 gap-3 px-4 py-4 rounded-sm mt-4'>
            ...
            <div className='flex basis-[20%] text-center justify-center'>
              <div className='border bg-slate-300 py-1 px-1'><FiMinus /></div>
              <div className=' border-slate-300 border-y py-0 px-7 text-[#333333]'>2</div>
              <div className='border  bg-slate-300 py-1 px-1  '><GoPlus/></div>
            </div>
          ...
          <div className='flex justify-between items-center'>
            ...
            <div className='flex  flex-col w-[400px] justify-center  py-4'>
              ...
              <Link to='checkout' className='text-center w-full border bg-orange-400 px-14 py-4 mt-4'>Checkout</Link>
            </div>
          </div>
