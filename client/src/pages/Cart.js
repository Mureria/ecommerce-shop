  ...
  return (
    <>
      <div className="w-full ">
        <div className="max-w-[1200px] mx-auto my-4 mb-10">
          {/* Header */}
          <div className={`hidden md:flex   gap-3 px-4 py-4 rounded-sm text-xl font-medium ${isDarkMode ? 'bg-[#202020]' : 'bg-slate-100'}`}>
          ...
          {/* product */}
          <div className={`flex flex-col md:flex-row items-start md:items-center justify-center gap-3 px-4 py-4 rounded-sm mt-4 ${isDarkMode ? 'bg-[#202020]' : ' bg-slate-100'}`}>
            <div className="basis-[30%]">
            ...
            <div className="flex basis-[20%] text-center justify-center">
              ...
              <div className=" border-y py-0 px-7">
                1
              </div>
              <div className="border py-1 px-1  ">
                <GoPlus />
            ...
            <div className="basis-[10%] text-center">
              <p className="text-sm text-[#909399] cursor-pointer hover:underline">Add to Wish</p>
              <p className="text-sm text-[#ff4444] cursor-pointer hover:underline">Delete</p>
            </div>
          </div>
