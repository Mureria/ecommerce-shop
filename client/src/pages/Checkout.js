...
const Checkout = () => {
  ...
  const id = '65a7ca4d61ec9899209fe150'
  ...
  return (
    <div className="w-full h-full">
      <div className="max-w-[1200px] mx-auto my-2 mb-4 px-4">
            ...
            <div className="basis-[30%]">
              <div className="flex h-full flex-1 items-center gap-3">
                ...
                <div className="w-[243px] m-0">
                  <p className="text-base">{products.name}</p>
        ...
        <div
          className={`flex gap-5 items-start md:gap-16 ${
            isDarkMode ? "bg-[#141414]" : "bg-slate-100"
          } my-10  px-6 pb-10 pt-4 rounded`}
        >
          ...
          <div>
            ...
            <div className="flex">
              <div
                className={` py-1 px-2 md:py-2 md:px-6 ${
                  isDarkMode ? "bg-[#000000]" : "bg-slate-100"
                } `}
              >
                Mpesa No.:
              </div>
          ...
          <div className="flex  flex-col w-[400px] justify-center  py-4">
            ...
            <div className="border-b border-slate-200 pb-3 pt-3">
              <div className="flex justify-between items-center">
                ...
                <p className="text-base font-medium">KSh 17,879</p>
              </div>
              <div className="flex justify-between items-center">
                <p className="text-base text-[#909399] font-medium ">
                  Shipping Fee:
                </p>
                <p className="text-base font-medium pb-4">+ KSh 388</p>
              </div>
              <div className="flex justify-between items-center border-t border-slate-200 pt-3">
                <p className="text-base md:text-lg text-[#909399] font-medium ">
                  Pay Amount:
                </p>
                <p className="text-base md:text-lg  font-medium">KSh 18,267</p>
              </div>
            </div>
            <button className="text-base md:text-lg w-full bg-orange-400 px-14 py-3 mt-4">
              Place Order
            </button>
          </div>
        </div>
