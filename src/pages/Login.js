...
const Login = () => {
  return (
   <>
    <div className="flex h-screen flex-col justify-center px-6 py-0 lg:px-0">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <CgProfile size={50} className="mx-auto" />
        <h2 className="mt-10 text-center text-2xl md:text-3xl font-bold leading-9 tracking-tight text-gray-900">Login to your account</h2>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between">
          <label for="password" class="block text-sm md:text-xl font-medium leading-6 text-gray-900">Password</label>
        </div>
        <div className="mt-2">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm md:text-xl font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Login</button>
      </div>
