  ...
  return (
    <>
      <div className='w-full text-xl bg-black text-gray-400 p-4'>
        <div className='max-w-[1200px] mx-auto my-10 grid grid-cols-2 md:grid-cols-6'>
          <div className='py-4'>
            <h1 className='text-gray-200 font-bold text-base'>About</h1>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
          ...
          <div className='py-4'>
            <h1 className='text-gray-200 font-bold text-base'>Partners</h1>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
          ...
          <div className='py-4'>
          <h1 className='text-gray-200 font-bold text-base'>Policy</h1>
          <p className='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p></div>
          <div className='py-4'>
            <h1 className='text-gray-200 font-bold text-base'>legal</h1>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
            <p className ='text-base'>Lorem ipsum colum</p>
